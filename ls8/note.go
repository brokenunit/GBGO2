...
// //1 функция -параллельный поиск и запись имен и размеров файлов
// //2 произвести поиск дубликатов в мапе
// // возможность активации удаления с подтверждением
// //
// var dir string

// func main() {
// 	fmt.Println("укажите директорию")
// 	fmt.Scanln(&dir)
// 	err := filepath.Walk(".",
